...
class Window:
    ...
    def title(self, parent):
        ...
        ft0 = tk_font.Font(family="微软雅黑", size=18, weight=tk_font.BOLD)
        tk.Label(frame,
                 font=ft0, bg="black",
                 fg="white", text="当前设置：").pack(side=tk.LEFT, padx=20)

        ft1 = tk_font.Font(family="微软雅黑", size=14, weight=tk_font.BOLD)
        tk.Label(frame,
                 height=2, font=ft1,
                 bg="black", fg="white",
                 textvariable=self.v_code_pack).pack(side=tk.LEFT, padx=5)
    ...
    def parameters(self, parent):
        ...
        ft1 = tk_font.Font(family="微软雅黑", size=12, weight=tk_font.BOLD)

        ft2 = tk_font.Font(family="微软雅黑", size=14, weight=tk_font.BOLD)
        ...
        self.p_expand = tk.Listbox(f_expand,
                                   listvariable=_var_expand, selectmode='single',
                                   width=20, height=3, font=ft1)
        ...
        self.p_anchor = tk.Listbox(f_anchor,
                                   listvariable=_var_anchor, selectmode='single',
                                   width=20, height=10, font=ft1)
        ...
        self.p_fill = tk.Listbox(f_fill,
                                 listvariable=_var_fill, selectmode='single',
                                 width=20, height=4, font=ft1)
        ...
        self.p_padx = tk.Spinbox(f_padx,
                                 from_=0, to=300, textvariable=self.v_padx,
                                 width=19, font=ft1, command=self.layout)
        ...
        self.p_pady = tk.Spinbox(f_pady, from_=0, to=300,
                                 textvariable=self.v_pady,
                                 width=19, font=ft1, command=self.layout)
