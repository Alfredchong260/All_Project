...
select id, name, cate_name, brand_name, price, is_show, is_saleoff
from goods;


-- 查询指定的字段
select name, cate_name, brand_name, price
from goods;
...
-- 查询去重
select cate_name, brand_name from goods;
select distinct cate_name, brand_name from goods;
# select distinct cate_name as '类型', brand_name as '品牌' from goods;
