...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        mb3x: function() {
            for (var a = this.J9A, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.bhT0x = d + 6) + 1), e = this.buR3x = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        Du0x: function(a, b, c, d, e, j, l, f) {
            for (var m = this.bhT0x, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
/*
d: "{\"id\":\"1837023024\",\"c\":\"[{\\\"id\\\":\\\"1837023024\\\"}]\",\"csrf_token\":\"\"}"
e: "010001"
...
/*
1835881918
d: "{\"id\":\"1835881918\",\"c\":\"[{\\\"id\\\":\\\"1835881918\\\"}]\",\"csrf_token\":\"\"}"
e: "010001"
f: ""
g: "0CoJUm6Qyw8W8jud"
*/
...
function start(id){
    ...
    var bKf6Z = asrsea(JSON.stringify(d), e, f, g);

    return bKf6Z
}

console.log(start(1835881918))
